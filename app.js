...
const STRINGS = {
  ...
  de: {
    ...
    file_label: "Datei",
    rows_label: "Zeilen",
    iterate_callout: "Iteriere frei in RStudio mit Microsoft Copilot. Wenn du sicher bist, füge deinen finalen Prompt unten ein — die Abgabe wird damit fixiert.",
    name_label: "Anzeigename",
    name_placeholder: "Erscheint in der Klassen-Bestenliste",
    prompt_label: "Dein finaler Prompt",
    prompt_placeholder: "Füge deinen ausgefeilten Prompt ein…",
    ...
    reflection_prompt: "Was würdest du bei deinem nächsten Prompt anders machen, wenn du das Urteil der Redaktion zugrunde legst?",
    reflection_sub: "Wird nicht bewertet — für deine Notizen.",
    ...
    enter_name_first: "Gib zuerst einen Anzeigenamen ein.",
    empty_prompt: "Leerer Prompt — schreibe zuerst etwas.",
    ...
    gate_desc: "Eine Übung zum Prompt-Engineering im Klassenraum. du erhältst ein Datenanalyse-Szenario und einen Datensatz; iteriere deinen Prompt lokal in RStudio mit Microsoft Copilot und reiche hier einmalig die finale, ausgefeilte Version ein. du erhältst zwei Punktzahlen zurück: sieben binäre mechanische Prüfungen und ein Urteil der Redaktion im Stil der Zielgruppe des Szenarios. Beide erscheinen in der Klassen-Bestenliste.",
